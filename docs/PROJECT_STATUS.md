...
- Phase: `P2.4`
- Current work package: `WP-P2_4-BROWSER-SANDBOX-PROVENANCE-RECONCILIATION`
...
| --- | --- | --- |
| Version sync | PASS_LOCAL | Package and phase metadata aligned to `1.2.13` / `P2.4` |
...
| --- | --- | --- |
| PPA-0001 | OPEN | Evidence provenance still needs post-push attestation for the reconciliation commit |
...
| PPA-0007 | CLOSED_LOCAL | Root resolver still prefers the active checkout |
