...
def build_env_specs(paths: ProjectPaths) -> tuple[EnvVarSpec, ...]:
    return (
        ...
        EnvVarSpec("AI_PROVIDER", _parse_string),
        EnvVarSpec("OPENAI_ENABLED", _parse_bool, allow_blank=False),
        EnvVarSpec("CLAUDE_ENABLED", _parse_bool, allow_blank=False),
        EnvVarSpec("GEMINI_ENABLED", _parse_bool, allow_blank=False),
        EnvVarSpec("DEEPSEEK_ENABLED", _parse_bool, allow_blank=False),
        EnvVarSpec("AI_PROVIDER_FALLBACK_ENABLED", _parse_bool, allow_blank=False),
        EnvVarSpec("AI_PROVIDER_FALLBACK_ORDER", _parse_string, allow_blank=False),
        EnvVarSpec("ALLOW_PAID_PROVIDER_SMOKE_TEST", _parse_bool, allow_blank=False),
        EnvVarSpec("OPENAI_MODEL", _parse_string),
        EnvVarSpec("CLAUDE_MODEL", _parse_string),
        EnvVarSpec("GEMINI_MODEL", _parse_string),
        EnvVarSpec("DEEPSEEK_MODEL", _parse_string),
        EnvVarSpec("OPENAI_TIMEOUT_SECONDS", _parse_int),
        EnvVarSpec("CLAUDE_TIMEOUT_SECONDS", _parse_int),
        EnvVarSpec("GEMINI_TIMEOUT_SECONDS", _parse_int),
        EnvVarSpec("DEEPSEEK_TIMEOUT_SECONDS", _parse_int),
        ...
        EnvVarSpec("MT5_GBPUSD_SYMBOL", _parse_string),
        EnvVarSpec("MT5_AUDUSD_SYMBOL", _parse_string),
        EnvVarSpec("MT5_NZDUSD_SYMBOL", _parse_string),
        EnvVarSpec("MT5_USDJPY_SYMBOL", _parse_string),
        EnvVarSpec("MT5_USDCHF_SYMBOL", _parse_string),
        EnvVarSpec("MT5_USDCAD_SYMBOL", _parse_string),
        EnvVarSpec("MT5_DXY_SYMBOL", _parse_string),
        EnvVarSpec("MT5_US10Y_SYMBOL", _parse_string),
        EnvVarSpec("FRED_ENABLED", _parse_bool, allow_blank=False),
        EnvVarSpec("FRED_API_KEY", _secret),
        EnvVarSpec("FRED_BASE_URL", _parse_url, allow_blank=False),
        EnvVarSpec("FRED_TIMEOUT_SECONDS", _parse_int, allow_blank=False),
        EnvVarSpec("FRED_MAX_RETRIES", _parse_int, allow_blank=False),
        EnvVarSpec("FRED_CACHE_TTL_SECONDS", _parse_int, allow_blank=False),
        EnvVarSpec("FRED_US10Y_SERIES_ID", _parse_string, allow_blank=False),
        EnvVarSpec("FRED_USD_BROAD_SERIES_ID", _parse_string, allow_blank=False),
